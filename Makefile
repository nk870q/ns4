...
cn2Simulator: read_input_file.o input_threads.o queue.o bld_routing_tbl.o cn2simulator.o
	gcc -pthread -o cn2Simulator  read_input_file.o input_threads.o queue.o bld_routing_tbl.o cn2simulator.o
